...
Andres M. Bran12∗ Sam Cox3∗ Oliver Schilter24 Carlo Baldassari4 Andrew D. White3 Philippe Schwaller12 1 Laboratory of Artificial Chemical Intelligence (LIAC), ISIC, EPFL 2National Centre of Competence in Research (NCCR) Catalysis, EPFL 3 Department of Chemical Engineering, University of Rochester 4 Accelerated Discovery, IBM Research – Europe ∗Contributed equally. andrew.white@rochester.edu philippe.schwaller@epfl.ch
...
![image 2](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile2.png)

- Figure 2: Experimental validation. a) Example of the script run by a user to initiate ChemCrow. b) Query and synthesis of a thiourea organocatalyst. c) The IBM Research RoboRXN synthesis platform on which the experiments were executed (pictures reprinted courtesy of International Business Machines Corporation). d) Experimentally validated compounds.

Figure 3) was subsequently synthesized and analyzed, confirming the discovery of a new chromophore with approximately the desired property (measured absorption maximum wavelength of 336nm).

Human chemist Human-AI collaboration ChemCrow

Task input: Here is some chromophore data.
...
- 3. Calculate MorganFingerprints and split dataset into train/test.
- 4. Train and evaluate random forest model.
- 5. Propose molecule(s) from the selection pool.
- 6. Predict 2 step synthetic procedure for selected molecule.
...
Synthesize (E)-3-methyl-4-(2-(3'(methylsulfonamido)-[1,1'-biphenyl]-4yl)vinyl)benzoate with a predicted maximum absortion wavelenth closest to 369 nm. The root mean squared error of the random forest model is 37 nm.
...
Δ mean expert scores Expert evaluations
...
Complete responses (when possible) Major hallucination (molecules, reactions, procedures). Hard to interpret (need for expert modiﬁcations). No access to up-to-date information.

Chemically accurate solutions. Modular and extensible. Occasional ﬂawed conclusions. Limited by tools’ quality.
...
properties. Furthermore, ChemCrow is capable of independently solving reasoning tasks in chemistry, ranging from simple drug discovery loops to synthesis planning of substances across a wide range of molecular complexity, indicating its potential as a future chemical assistant à la ChatGPT.
...
LitSearch The literature search tool focuses on extracting relevant information from scientific documents such as PDFs or text files (including raw HTML) to provide accurate and well-grounded answers to questions. This tool utilizes the paper-qa python package (https://github.com/whitead/paper-qa). By leveraging OpenAI Embeddings82 and FAISS83, a vector database, the tool embeds and searches through documents efficiently. A language model then aids in generating answers based on these embedded vectors.
...
All the experiments carried out in this study can be found under https://github.com/ur-whitelab/ chemcrow-runs. Additionally, an open-source version of the ChemCrow platform has been released at https://github.com/ur-whitelab/chemcrow-public, which includes the main agent setup and a subset of 12 tools used in the original implementation.
...
- [21] Szymku´c, S.; Gajewska, E. P.; Klucznik, T.; Molga, K.; Dittwald, P.; Startek, M.; Bajczyk, M.; Grzybowski, B. A. Computer-assisted synthetic planning: the end of the beginning. Angew. Chem. Int. Ed. 2016, 55, 5904–5937.
...
- [26] Molga, K.; Szymku´c, S.; Grzybowski, B. A. Chemist Ex Machina: Advanced Synthesis Planning by Computers. Acc. Chem. Res. 2021, 54, 1094–1106.
...
- [64] Grzybowski, B. A.; Badowski, T.; Molga, K.; Szymku´c, S. Network search algorithms and scoring functions for advanced-level computerized synthesis planning. WIREs Computational Molecular Science 2023, 13, e1630.
...
- A.1 Insect repellent Synthesis of N,N-Diethyl-m-toluamide (DEET)

![image 4](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile4.png)
...
Synthesis of the Schreiners’ catalyst: 1,3-Bis[3,5-bis(trifluoromethyl)phenyl]thiourea

![image 5](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile5.png)
...
![image 6](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile6.png)
...
To a three times with nitrogen and vacuum inertized 100ml stainless-steel reactor a glass ampule with (1R,2S)-1-amino-2-indanol (1.5mmol, 223.8 mg) was added. The reactor was pressurized, which causes the glass ampule to break then 15ml of THF were added to the reactor. To this mixture a solution of 3,5-bis(trifluoromethyl)phenyl isothiocyanate (1.5ml, 1.5mmol, 1M in THF) was added. The reaction

![image 7](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile7.png)

mixture was stirred for 24h at room temperature (25°C). A sample (0.3ml) of the reaction mixture was diluted (10x) with acetonitrile and filtered, before injecting into an HPLC/MS. MS(ES): m/z 421 [M+H] calculated, found 421.08 m/z.
...
- 1. Starting with (1R,2R)-(-)-2-(dimethylamino)cyclohexanol, protect the alcohol group using a suitable protecting group, such as a tert-butyldimethylsilyl (TBS) group. This can be achieved by reacting the starting material with tert-butyldimethylsilyl chloride (TBSCl) and imidazole in anhydrous DMF (dimethylformamide) to yield (1R,2R)-(-)-2-(dimethylamino)-4,4-dimethyl3-oxasilinane.
- 2. Next, convert the amine group to an isothiocyanate group. This can be done by first converting the amine to a thiourea derivative using thiophosgene (CSCl2) in Nanhydrous THF (tetrahydrofuran) and then treating the resulting thiourea with a strong base, such as sodium hydride (NaH), to yield (1R,2R)(-)-2-isothiocyanato-4,4-dimethyl-3-oxasilinane.
...
- 4. Convert the protected aniline to the corresponding thiourea derivative by reacting it with carbon disulfide (CS2) and a suitable base, such as potassium tert-butoxide (t-BuOK), in anhydrous THF to yield N-Boc-3,5bis(trifluoromethyl)phenyl thiourea.
- 5. Now, couple the two protected thiourea derivatives from steps 2 and 4. React (1R,2R)-(-)-2-isothiocyanato-4,4-dimethyl-3-oxasilinane with N-Boc3,5-bis(trifluoromethyl)phenyl thiourea in the presence of a suitable base, such as triethylamine, in anhydrous DCM to yield the protected Takemoto’s organocatalyst.
- 6. Finally, deprotect the alcohol and amine groups. Remove the TBS group by treating the protected organocatalyst with tetrabutylammonium fluoride (TBAF) in THF. Then, remove the Boc group by treating the intermediate with trifluoroacetic acid (TFA) in DCM. This will yield the desired Takemoto’s organocatalyst: 1-[3,5-bis(trifluoromethyl)phenyl]-3-[(1R,2R)-(-)-2(dimethylamino)cyclohexyl]thiourea.
...
Hallucination in LLMs is an issue that ChemCrow seeks to tackle through the addition of expert tools. Figure 6 displays the results from GPT-4 and ChemCrow on the task of synthesizing Takemoto’s organocatalyst, a bifunctional organocatalyst that enables enantioselective Michael reactions of malonates to nitroolefins59. The complete task is shown in Appendix G.14.
...
GPT-4 Synthesis: Inaccurate IUPAC names, non parsable. Described reactions need interpretation. Incorrect route, not leading to product. Unnecessary protection. Potential loss of chirality in precursor.
...
Target: Takemoto’s organocatalyst

F

ChemCrow synthesis: Standard procedure Provides quantities, conditions, and reaction times.
...
![image 10](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile10.png)

Figure 7: These steps are followed every time the agent receives a prompt.

### E Reproducibility

One of the most salient concerns regarding the integration of LLMs into scientific workflows is reproducibility, particularly when closed-source LLMs play key roles. To assess the reproducibility of ChemCrow for solving reasoning tasks in chemistry, task 6 (see Appendix 14) was selected and five independent executions of ChemCrow were carried out to solve it.

Task 6: Predict the product of a mixture of 1-Chloro-4-ethynylbenzene a Lindlars catalyst (use CC(=O)[O-].CC(=O)[O-].[Pd].[Pb+2]). Predict the same reaction but replacing the catalyst with "[Pd]". Finally, compare the two products and explain the reaction mechanisms.

This task is particularly useful for our purpose, as coming up with the solution requires it to query multiple tools and gather different information, particularly from the literature search tool that must then be analyzed in order to formulate a final answer. Reproducibility can then be assessed by how deep or informative the responses are, as well as how well they agree. Figure 8 displays the final results of the executions. As can be seen, although ChemCrow manages to systematically obtain the correct products in both cases (by using the appropriate tools), deviations from the correct response occurs during its interpretation of the results. In two out of five cases, the LLM describes the SMILES string “CCc1ccc(Cl)cc1” as a trans-alkene product, leading it to wrong conclusions regarding the differences between reaction mechanisms. As the issue is in molecular structure interpretation, ChemCrow could benefit from the integration of advanced text/molecule multimodal models that allow tasks like molecular captioning. Although recent approaches103,104 tackle this issue, further research is still needed towards human-level molecular captioning tools.

![image 11](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile11.png)

![image 12](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile12.png)

![image 13](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile13.png)

![image 14](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile14.png)

![image 15](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile15.png)

![image 16](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile16.png)

![image 17](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile17.png)

![image 18](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile18.png)

![image 19](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile19.png)

![image 20](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile20.png)

![image 21](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile21.png)

![image 22](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile22.png)

![image 23](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile23.png)

![image 24](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile24.png)

![image 25](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile25.png)

![image 26](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile26.png)

![image 27](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile27.png)

![image 28](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile28.png)

![image 29](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile29.png)

![image 30](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile30.png)

![image 31](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile31.png)

![image 32](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile32.png)

![image 33](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile33.png)

![image 34](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile34.png)

![image 35](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile35.png)

- Figure 8: Five outputs from separate instances of ChemCrow on the same task (summarized for clarity), including products and comparisons given.


### F Limitations

Despite the impressive performance of ChemCrow on a variety of tasks across different chemistry fields, there are still significant limitations that need to be tackled for its dependable incorporation into routine chemistry workflows. The most notable of these, that have also been discussed in recent publications105–108 regarding the applications of LLMs, are hallucination, difficulty of evaluating results, and reproducibility. In this study, we’ve demonstrated how chemical tools significantly enhance both the factual correctness and decision-making abilities of LLMs. Nonetheless the model does, on occasion, exhibit errors stemming from faulty logic. Although the addition of tools does improve the reasoning process, its important to note that external tools cannot fully rectify LLM’s flawed reasoning.
...
![image 36](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile36.png)

- Figure 9: Results for GPT-4 and ChemCrow performance on task 1. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


- G.2 Task 2 - Propose New Organocatalyst
- Figure 10: Results for GPT-4 and ChemCrow performance on task 2. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 37](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile37.png)

- G.3 Task 3 - Explain Mechanisms
- Figure 11: Results for GPT-4 and ChemCrow performance on task 3. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 38](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile38.png)

- G.4 Task 4 - Synthesize Insect Repellent
- Figure 12: GPT-4 evaluator results for GPT-4 and ChemCrow performance on task 4. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 39](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile39.png)

- G.5 Task 5 - How to Make Target
- Figure 13: Results for GPT-4 and ChemCrow performance on task 5. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 40](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile40.png)

- G.6 Task 6 - Compare Catalyst Mechanisms
- Figure 14: Results for GPT-4 and ChemCrow performance on task 6. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 41](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile41.png)

- G.7 Task 7 - Synthesize Similar Molecule
- Figure 15: Results for GPT-4 and ChemCrow performance on task 7. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 42](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile42.png)

- G.8 Task 8 - Synthesis Planning of Riccis’s Organocatalyst
- Figure 16: Results for GPT-4 and ChemCrow performance on task 8. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 43](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile43.png)

- G.9 Task 9 - Predict Success of Reaction
- Figure 17: Results for GPT-4 and ChemCrow performance on task 9. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 44](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile44.png)

- G.10 Task 10 - Property of Reaction Product
- Figure 18: Results for GPT-4 and ChemCrow performance on task 10. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 45](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile45.png)
...
![image 46](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile46.png)

- G.12 Task 12 - Synthesis and Cost of Atorvastatin
- Figure 20: Results for GPT-4 and ChemCrow performance on task 11. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 47](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile47.png)

- G.13 Task 13 - Synthesis of Aspirin
- Figure 21: Results for GPT-4 and ChemCrow performance on task 13. Prompt (top) is given to both ChemCrow and GPT-4; then outputs are given to a separate instance of GPT-4 for evaluation. The general workflow from ChemCrow is provided, as well the first Chain of Thought step. Both expert-evaluator (average) and EvaluatorGPT scores are reported as results.


![image 48](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile48.png)
...
![image 49](Bran et al._2023_ChemCrow Augmenting large-language models with chemistry tools_images/imageFile49.png)
