...
- 🏛 기반 연구: [[papers/990_Networks_of_Scientific_Papers/review]] — 과학 논문 네트워크의 서지 결합 패턴에 대한 초기 연구로서 인용 분석 도구 발전의 이론적 토대를 마련했다.
- 🔗 후속 연구: [[papers/1009_Relative_Citation_Ratio_A_New_Metric_That_Uses_Citation_Rate/review]] — 상대 인용 비율이라는 새로운 지표 개발을 통해 전통적인 인용 분석의 한계를 극복하는 발전된 평가 도구를 제시한다.
- 🔗 후속 연구: [[papers/1053_Visualizing_the_context_of_citations_referencing_papers_publ/review]] — 저널 평가에서 단순 인용 분석을 인용 맥락의 질적 분석으로 확장한다.
- 🧪 응용 사례: [[papers/941_Big_Names_or_Big_Ideas_Do_Peer-Review_Panels_Select_the_Best/review]] — 동료평가의 한계를 저널 평가에서도 나타나는 인용 분석의 문제와 연계하여 이해할 수 있음
- 🔗 후속 연구: [[papers/990_Networks_of_Scientific_Papers/review]] — 인용 분석이 저널 평가 도구로 발전한 과정이 초기 연구 전선 분석의 실용적 응용 사례이다.
- 🧪 응용 사례: [[papers/1081_Science_Citation_IndexA_New_Dimension_in_Indexing_This_uniqu/review]] — 저널 평가 도구로서 인용 분석의 실제적 활용을 보여주어 Science Citation Index의 구체적 응용 사례를 제시한다.
